...
class MagentoLocation(object):
    ...
    def __init__(self, location, username, password,
                 use_custom_api_path=False, verify_ssl=True, version=None):
    ...
    def call(self, method, arguments=None, http_method=None, storeview=None):
        try:
            ...
            try:
                ...
                _logger.error("api.call('%s', %s, %s, %s) failed",
...
class MagentoCRUDAdapter(AbstractComponent):
    ...
    def _call(self, method, arguments=None, http_method=None, storeview=None):
        ...
        return magento_api.call(method, arguments, http_method=http_method, storeview=storeview)
