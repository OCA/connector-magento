...
class MagentoBackend(models.Model):
    ...
    default_attribute_set = fields.Integer(
        string="Attribute Set ID from Magento", default=4, required=True
    )
    ...
    default_currency = fields.Many2one(
        comodel_name="res.currency", required=True, default=_get_default_currency
    )
