...
class TestImportProductImage(SavepointComponentRegistryCase):
    ...
    def setUpClass(cls):
        ...
        cls.create_binding_no_export("magento.product.category", existing_category, 1)
    ...
    def test_image_priority(self):
        ...
        self.assertEqual(
            self.image_importer._sort_images(images), [file4, file3, file2, file1]
        )
    ...
    def test_import_images_404(self):
        ...
        binding.id = 999
        binding_no_export = mock.MagicMock(name="magento.product.product,999:no_export")
