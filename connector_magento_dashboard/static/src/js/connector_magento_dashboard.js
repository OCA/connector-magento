odoo.define('connector_magento_dashboard.dashboard', function (require) {
"use strict";
...
var ConnectorMagentoDashboardView = KanbanView.extend({
    ...
    fetch_data: function() {
        return new Model('magento.backend')
...
core.view_registry.add('connector_magento_dashboard', ConnectorMagentoDashboardView);

return ConnectorMagentoDashboardView;
