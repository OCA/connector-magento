...
Install ``connector_magento_export_partner``.
...
Edit the partner you want to export, in the Connector tab (needs ``Connector
Manager`` access), add an entry with the destination backend.
