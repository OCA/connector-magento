...
class MagentoExporter(Component):
    ...
    def _export_dependency(self, relation, binding_model, exporter=None,
        ...
        :param exporter: Component to use for export
        :type exporter: :py:class:`odoo.addons.component.core.Component`
        ...
        if not rel_binder.to_backend(binding):
            if exporter is None:
                exporter = self.components(usage='exporter',
