...
class magento_backend(orm.Model):
    ...
    _columns = {
        ...
        'import_claim_comments_from_date': fields.datetime('Import claim comments from date'),
        'import_claim_attachments_from_date': fields.datetime('Import claim attachments from date'),
        }
    ...
    def _scheduler_import_claim_comments(self, cr, uid, domain=None, context=None):
        self._magento_backend(cr, uid, self.import_claim_comment,
                              domain=domain, context=context)

    def _scheduler_import_claim_attachments(self, cr, uid, domain=None, context=None):
