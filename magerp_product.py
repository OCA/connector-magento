...
class product_category(magerp_osv.magerp_osv):
    ...
    def record_category(self, cr, uid, id, conn, category_id):
        ...
        imp_vals = conn.transform(conn.call('category.info', [category_id]))
        vals = {}
...
#        if vals['value'] or vals['label']:
#            return super(magerp_product_attribute_options,self).create(cr,uid,vals,ctx)
#            
